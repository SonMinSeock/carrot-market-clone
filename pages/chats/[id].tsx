      ...
      <div className="fixed w-full mx-auto max-w-md bottom-2 inset-x-0">
        <div className="relative flex items-center">
          ...
          <div className="absolute inset-y-0 flex py-1.5 pr-1.5 right-0">
            <button className="flex focus:ring-2 focus:ring-offset-2 focus:ring-orange-500 items-center rounded-full px-3 text-sm text-white bg-orange-500 hover:bg-orange-600">
              &rarr;
            </button>
          </div>
        </div>
