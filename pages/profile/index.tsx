...
const Profile: NextPage = () => {
  ...
  const navigateSold = () => router.push(`/profile/sold`);
  const navigateLoved = () => router.push(`/profile/loved`);
  const navigateBought = () => router.push(`/profile/bought`);
      ...
      <div className="py-10 px-4">
        ...
        <div className="mt-10 flex justify-around">
          <div className="flex flex-col items-center">
            <div
              className="w-14 h-14 text-white bg-orange-500 rounded-full flex justify-center items-center cursor-pointer"
              onClick={navigateSold}
            >
              <svg
                className="w-6 h-6"
                fill="none"
        ...
        <div className="mt-12">
          <div className="flex space-x-4 items-center">
            ...
            <div>
              <h4 className="text-sm font-bold text-gray-800">Son</h4>
