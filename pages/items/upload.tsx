    ...
    <div className="px-4 py-16">
      ...
      <div className="my-5">
        ...
        <div className="rounded-md relative flex items-center shadow-sm">
          ...
          <input
            id="price"
            className="appearance-none w-full px-3 pl-7 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-orange-500 focus:border-orange-500"
            type="text"
            placeholder="0.00"
          />
