  ...
  return (
    <div className="bg-slate-400 dark py-20 px-10 grid lg:grid-cols-2 xl:grid-cols-3 xl:place-content-center gap-10 min-h-screen">
      ...
      <div className="bg-white dark:bg-black flex flex-col justify-between p-6 rounded-3xl shadow-xl">
        ...
        <button className="mt-5 bg-blue-500 text-white dark:bg-black dark:border-white dark:border p-3 text-center rounded-xl w-3/4 mx-auto dark:hover:bg-white hover:bg-teal-500 hover:text-black active:bg-yellow-500 focus:bg-red-500">
          Checkout
        </button>
      </div>
      <div className="bg-white overflow-hidden rounded-3xl shadow-xl">
        <div className="portrait:bg-indigo-600 landscape:bg-teal-500 p-6 pb-14 xl:pb-40 flex justify-between">
